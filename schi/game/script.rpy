...
define tryvozhnist = Character("Тривожність")
...
label bar:
    ...
    tryvozhnist "яка ж вона гарна. Вона дивиться на мене?  Боже, чувак, тільки не налажай"
    ...
    tryvozhnist "{i}Що вона щойно сказала?{/i}"
